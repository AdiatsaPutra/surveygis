...
<div class="map-location container-fluid">
    ...
    <div class="row">
        <div class="col-md-4 mb-5">
            <form method="post" action="/add-data" enctype="multipart/form-data" name="myForm" class="dropzone"
                onsubmit="required()">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <!-- <div class="col-sm-12">
                        <div class="mb-1">
                            ...
                            <input multiple type="file" class="form-control" id="foto" onchange="preview()" name="foto">
